...
public class ComboList : MonoBehaviour
{
    ...
    public List<Combo> duoComboList = new List<Combo>()
    {
        ...
        new Combo(ComboType.Duo, new List<KeyCode> { KeyCode.DownArrow, KeyCode.DownArrow, KeyCode.LeftArrow, KeyCode.RightArrow }),
        ...
        new Combo(ComboType.Duo, new List<KeyCode> { KeyCode.RightArrow, KeyCode.RightArrow, KeyCode.RightArrow, KeyCode.RightArrow })
    };
}
