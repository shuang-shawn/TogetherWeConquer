...
public class ComboList : MonoBehaviour
{
    ...
    public List<Combo> soloComboList = new List<Combo>()
    {
        ...
        new Combo(ComboType.Solo, new List<KeyCode> { KeyCode.DownArrow, KeyCode.DownArrow, KeyCode.LeftArrow, KeyCode.RightArrow }, "stone"),
    ...
    public List<Combo> duoComboList = new List<Combo>()
    {
        ...
        new Combo(ComboType.Duo, new List<KeyCode> { KeyCode.RightArrow, KeyCode.RightArrow, KeyCode.RightArrow, KeyCode.RightArrow, KeyCode.RightArrow, KeyCode.RightArrow }, "snipe")
    };
}
